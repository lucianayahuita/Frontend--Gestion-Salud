  ...
  <div class="inventario-container">
    ...
    <header class="page-header">
        <div class="header-info">
          ...
          <p class="page-subtitle">Consulta en tiempo real el historial de entradas y salidas de medicamentos en la farmacia.</p>
        </div>
...
.page-title { font-family: 'Sora', sans-serif; font-size: 20px; font-weight: 700; color: #115843; margin: 0; }
